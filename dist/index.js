...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`,
    ...
    var h, x = {}, N = R.react_stack_bottom_frame.bind(
      R,
      s
    )(), C = O(i(s)), Y = {};
